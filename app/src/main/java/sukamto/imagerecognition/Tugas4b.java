...
public class Tugas4b extends AppCompatActivity {
    ...
    public void addPicture(View view){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Tugas4b.this);
    ...
    public void choosePicture(){
        try{
            if (ActivityCompat.checkSelfPermission(Tugas4b.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Tugas4b.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, MainModel.REQUEST_SELECT_IMAGE);
            } else{
    ...
    public void sevenSegmentRecognition(View view){
        String[] result = MainModel.checkNumber2(MainModel.getImageBitmap());
