...
public class Tugas6 extends AppCompatActivity {
    ...
    public void addPicture(View view){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Tugas6.this);
    ...
    public void choosePicture(){
        try{
            if (ActivityCompat.checkSelfPermission(Tugas6.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Tugas6.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE}, MainModel.REQUEST_SELECT_IMAGE);
            } else{
